...
open class FormBaseCell: UITableViewCell {
    ...
    public required override init(style: UITableViewCellStyle, reuseIdentifier: String!) {
        ...
        self.selectionStyle = UITableViewCellSelectionStyle.none // JOEY!
    }
    ...
    open override func updateConstraints() {
        ...
        if let visualConstraintsClosure = rowDescriptor.configuration[FormRowDescriptor.Configuration.VisualConstraintsClosure] as? VisualConstraintsClosure {
            ...
            visualConstraints = self.defaultVisualConstraints() as NSArray!
        }
        
        for visualConstraint in visualConstraints {
            let constraints = NSLayoutConstraint.constraints(withVisualFormat: visualConstraint as! String, options: NSLayoutFormatOptions(rawValue: 0), metrics: nil, views: views)
